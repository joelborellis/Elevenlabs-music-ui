...
const BLUEPRINT_CONTENT: Record<ProjectBlueprint, BlueprintContent> = {
  ad_brand_fast_hook: {
    ...
    tips: [
      'Describe your brand personality and values',
      'What emotion should viewers feel after watching?',
      'Who is your target audience?',
      'Any specific call-to-action or tagline to incorporate?',
    ],
    icon: (
  ...
  podcast_voiceover_loop: {
    ...
    description: 'Tell us about your podcast so we can create the perfect background bed that complements your content.',
  ...
  standalone_song_mini: {
    ...
    description: 'Tell us about the person, occasion, or story that will inspire this song. Personal details help us create something truly meaningful.',
    ...
    tips: [
      'Who is this song for and what\'s the occasion?',
      'Share personal details, names, or inside jokes',
      'What emotions do you want to capture?',
      'Any specific phrases or memories to include?',
    ],
    icon: (
      <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
    ...
    >
      ...
      <div className="max-w-3xl mx-auto">
        ...
        <motion.div
          ...
          className="mb-8"
        >
          <Button variant="ghost" onClick={prevStep} disabled={isGeneratingPrompt}>
        ...
        <div className="text-center">
          ...
          <motion.h2
            ...
            className="font-display text-4xl md:text-5xl lg:text-6xl text-foreground mb-6 leading-[1.1]"
          >
          ...
          <CardContent className="space-y-6">
            <div className="space-y-3">
              ...
              <Textarea
                ...
                className="min-h-[220px] resize-y text-base leading-relaxed placeholder:text-muted-foreground/50 rounded-xl border-border/60 bg-background/50 focus:bg-background transition-colors"
              />
            </div>
      ...
      >
        <Button
          ...
          size="xl"
          disabled={isGeneratingPrompt}
          className="group gap-3 min-w-[280px]"
        >
          {isGeneratingPrompt ? (
            <>
